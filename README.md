...
## 🚀 INTRO
> 안녕하십니까! 현재 **BSS 운영 및 시스템 SM을 담당하는 개발자 안효준**입니다.  
> 다수의 풀스택 프로젝트 경험과 **ITSM/SM 실무 역량**을 바탕으로, 안정적이고 효율적인 시스템 환경을 구축합니다.  
> 끊임없이 배우고 기록하며, 문제를 근본적으로 해결해 나가는 과정을 즐깁니다!
...
- **주요 담당 업무:**
  - [담당 업무 1 - WhaTap APM 기반 시스템 성능 모니터링 및 장애 대응]
  - [담당 업무 2 - 비동기 포털 시스템 개발 및 운영]
- **Tech Stack:** [Java, Spring Boot, MySQL, Kubernetes, WhaTap 등]
